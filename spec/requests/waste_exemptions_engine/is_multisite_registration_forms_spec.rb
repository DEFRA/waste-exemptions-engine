...
module WasteExemptionsEngine
  RSpec.describe "Is Multisite Registration form" do
    ...
    it_behaves_like "GET form", :is_multisite_registration_form, "/is-multisite-registration"
    it_behaves_like "POST form", :is_multisite_registration_form, "/is-multisite-registration" do
