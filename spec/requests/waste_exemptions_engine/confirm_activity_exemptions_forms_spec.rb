...
module WasteExemptionsEngine
  RSpec.describe "Confirm Activity Exemptions Forms" do
    it_behaves_like "GET form", :confirm_activity_exemptions_form, "/your-selected-exemptions"
    ...
    context "when adding exemptions in the new charged registration flow" do
      ...
      it "directs to confirm activity exemptions form when submitted" do
        ...
        expect(response).to redirect_to(is_multisite_registration_forms_path(confirm_activity_exemptions_form.token))
      end
    end
  end
end
