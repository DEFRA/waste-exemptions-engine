...
module WasteExemptionsEngine
  RSpec.describe "Check Your Answers Forms", :vcr do
    ...
    context "when editing data on Check Your Answers" do
      ...
      describe "GET /check-your-answers/operator-address" do
        it_behaves_like "a valid transition", :operator_address_check_your_answers_forms_path, :new_operator_postcode_form_path
      end
