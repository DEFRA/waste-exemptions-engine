        ...
        context "when new_registration.skip_registration_number? is true" do
          ...
          [TransientRegistration::BUSINESS_TYPES[:charity],
           ...
           TransientRegistration::BUSINESS_TYPES[:sole_trader]].each do |business_type|
            before do
              new_registration.business_type = business_type
              # For charity, we need to ensure charity_in_front_office? returns false
              if business_type == TransientRegistration::BUSINESS_TYPES[:charity]
