...
module WasteExemptionsEngine
  RSpec.describe NewRegistration do
    describe "#workflow_state" do
      current_state = :registration_lookup_email_form
      next_state = :registration_lookup_complete_form
      ...
      context "when a NewRegistration's state is #{current_state}" do
        ...
        it "can only transition to :registration_lookup_complete_form" do
        ...
        it "transitions to :registration_lookup_complete_form" do
