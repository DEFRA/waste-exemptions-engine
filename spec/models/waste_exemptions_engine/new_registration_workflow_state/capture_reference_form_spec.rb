...
module WasteExemptionsEngine
  RSpec.describe NewRegistration do
    describe "#workflow_state" do
      current_state = :capture_reference_form
      next_state = :capture_email_form
      ...
      context "when a NewRegistration's state is #{current_state}" do
        ...
        it "can only transition to :capture_email_form" do
        ...
        it "transitions to :capture_email_form" do
