...
FactoryBot.define do
  factory :contact_postcode_form, class: "WasteExemptionsEngine::ContactPostcodeForm" do
    initialize_with do
      new(create(:new_charged_registration, workflow_state: "contact_postcode_form"))
    end
  end

  factory :edit_contact_postcode_form, class: "WasteExemptionsEngine::ContactPostcodeForm" do
    initialize_with do
      new(create(:front_office_edit_registration, workflow_state: "contact_postcode_form"))
    end
  end
