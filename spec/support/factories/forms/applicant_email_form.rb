...
FactoryBot.define do
  ...
  factory :renewal_start_edit_applicant_email_form, class: "WasteExemptionsEngine::ApplicantEmailForm" do
    initialize_with do
      new(create(:renewing_registration, workflow_state: "applicant_email_form", applicant_email: "test@test.com",
                                         temp_check_your_answers_flow: true))
    end
  end
