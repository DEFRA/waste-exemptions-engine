...
FactoryBot.define do
  factory :contact_position_form, class: "WasteExemptionsEngine::ContactPositionForm" do
    initialize_with do
      new(create(:new_charged_registration, workflow_state: "contact_position_form"))
    end
  end

  factory :edit_contact_position_form, class: "WasteExemptionsEngine::ContactPositionForm" do
    initialize_with do
      new(create(:front_office_edit_registration, workflow_state: "contact_position_form"))
    end
  end
