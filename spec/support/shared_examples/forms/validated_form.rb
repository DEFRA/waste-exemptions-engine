    ...
    context "when the form is valid" do
      it "should submit" do
        ...
        params.each do |valid_param_set|
          expect(form.submit(ActionController::Parameters.new(valid_param_set).permit!)).to eq(true)
        end
      end
    end
    ...
    context "when the form is not valid" do
      it "should not submit" do
        ...
        params.each do |invalid_param_set|
          expect(form.submit(ActionController::Parameters.new(invalid_param_set).permit!)).to eq(false)
        end
      end
    end
  end
